...
resource functionApp 'Microsoft.Web/sites@2021-03-01' = {
  ...
  resource functionAppConfig 'config@2021-03-01' = {
    ...
    properties: {
      ...
      'AzureWebJobsStorage': 'DefaultEndpointsProtocol=https;AccountName=${fabiostorageaccount92};AccountKey=${IaFNKypOLTELVyYkEgBdNh4gLPajfSIITRNMwAPqiR/5rFRbWgHRWvuy539Fy9ZvDhT6VezQ46X8+AStwnzq2Q(resourceId('Microsoft.Storage/storageAccounts', storageAccount.name), '2021-08-01').keys[0].value};EndpointSuffix=core.windows.net'
      'FUNCTIONS_EXTENSION_VERSION': '~4'
      'FUNCTIONS_WORKER_RUNTIME': 'dotnet'
      'WEBSITE_CONTENTAZUREFILECONNECTIONSTRING': 'DefaultEndpointsProtocol=https;AccountName=${$fabiostorageaccount92};AccountKey=${IaFNKypOLTELVyYkEgBdNh4gLPajfSIITRNMwAPqiR/5rFRbWgHRWvuy539Fy9ZvDhT6VezQ46X8+AStwnzq2Q(resourceId('Microsoft.Storage/storageAccounts', storageAccount.name), '2019-04-01').keys[0].value};EndpointSuffix=core.windows.net'
